...
function AdminView({ session, athletes, trainings, bestTimes, onLogout, onAddAthlete, onDeleteAthlete, onUpdateAthlete, onAddTraining, onDeleteTraining, onUpdateBT, onAddBT, onDeleteBT, onRefresh }) {
  ...
  const TABS=[{id:"dashboard",icon:"📊",label:"Dashboard"},{id:"perfil",icon:"👤",label:"Perfil 360"},{id:"trainings",icon:"📋",label:"Treinos"},{id:"gym",icon:"🏋️",label:"Musculação"},{id:"athletes",icon:"🚣",label:"Atletas"},{id:"besttimes",icon:"🏆",label:"Best Times"},{id:"wellness",icon:"💚",label:"Bem-Estar"},{id:"steptest",icon:"🔬",label:"Step Test"}];
  return (
